#!/usr/bin/env python3
# agregator.py — Backend Node.js / Express / Prisma
import os
import sys
import re
import argparse
...
class AggregatorConfig:
    ...
    # 3. Whitelist Folder yang Diizinkan untuk Ditelusuri (Backend Node.js)
    ALLOWED_DIRS = {
        "src", "prisma", "config", "controllers", "middlewares",
        "routes", "services", "utils", "helpers", "models",
        "validators", "jobs", "queues", "migrations", "seeders"
    }

    # 4. Ekstensi Berkas Teks yang Diizinkan untuk Backend Node.js
    INCLUDE_EXTENSIONS = {
        ".js", ".mjs", ".cjs", ".json", ".prisma",
        ".yaml", ".yml", ".md", ".env.example", ".sh"
    }

    # 5. Berkas Konfigurasi Wajib di Tingkat Root
    ESSENTIAL_ROOT_FILES = {
        "package.json", "index.js", "server.js", "app.js",
        ".env.example", "nodemon.json", "jest.config.js",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Optimasi Bundel Kode Backend Node.js/Prisma - GFW Paradigm")
